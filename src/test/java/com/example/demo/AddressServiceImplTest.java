...
class AddressServiceImplTest {
	...
	void testAddAddress_CustomerNotFound() {
		...
		RuntimeException ex = assertThrows(RuntimeException.class, () -> addressService.addAddress(1, address));
	...
	void testUpdateAddress_NotFound() {
		...
		RuntimeException ex = assertThrows(RuntimeException.class, () -> addressService.updateAddress(1L, address));
	...
	void testGetUserAddress_NotFound() {
		...
		RuntimeException ex = assertThrows(RuntimeException.class, () -> addressService.getUserAddress(1L));
